...
def avail_dir(tmp_path, monkeypatch):
    ...
    import unseen_university.devices.granny.availability as av
...
class TestMarkAvailable:
    def test_mark_available_creates_true_file(self, avail_dir):
        from unseen_university.devices.granny.availability import is_available, mark_available
    ...
    def test_mark_unavailable_creates_false_file(self, avail_dir):
        from unseen_university.devices.granny.availability import is_available, mark_unavailable
    ...
    def test_clear_removes_both_files(self, avail_dir):
        from unseen_university.devices.granny.availability import clear_worker_state, is_available
...
class TestDickSimnelAvailability:
    def test_dicksimnel_available_when_true_flag_set(self, tmp_path, monkeypatch):
        import unseen_university.devices.granny.availability as avail
