...
class TestUrgencyProvenance(unittest.TestCase):
    ...
    def _run(self, twm_items, lower_calls=None):
        ...
        from wild_igor.igor.tools import urgency_provenance as up
        ...
        with patch.object(
            ...
            "wild_igor.igor.tools.urgency_provenance.trace_urgency_provenance.__globals__",
            create=True,
        ):
            pass
...
class TestMemoryProvenanceTools(unittest.TestCase):
    ...
    def test_validate_memory_sets_status(self):
        ...
        from wild_igor.igor.tools import memory_provenance as mp
