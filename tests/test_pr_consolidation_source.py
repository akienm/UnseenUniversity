...
def _fresh_source():
    from wild_igor.igor.cognition.pr_consolidation_source import PRConsolidationSource
...
def test_push_rate_limit_releases_after_interval():
    ...
    from wild_igor.igor.cognition.pr_consolidation_source import MIN_INTERVAL_SEC
