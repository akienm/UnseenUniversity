...
class TestComputeStallInfo:
    ...
    def test_falls_back_to_updated_at_when_no_claimed_at(self):
    ...
    def test_claimed_at_wins_over_updated_at(self):
...
class TestFindStalls:
    def test_returns_empty_when_no_stalls(self):
        tasks = [
            {"status": "in_progress", "id": "T-a", "claimed_at": _ts(1.0)},
    ...
    def test_returns_stalls_sorted_oldest_first(self):
        tasks = [
            ...
            {"status": "in_progress", "id": "T-c", "title": "c", "worker": "c",
             "claimed_at": _ts(1.0)},  # not stalled
        ]
