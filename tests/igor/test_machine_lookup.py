...
def test_machine_lookup_resolves_canonical_hostname():
    from unseen_university.devices.igor.tools.machine_lookup import machine_lookup
...
def test_machine_list_all_returns_all_registered_machines():
    from unseen_university.devices.igor.tools.machine_lookup import machine_list_all
...
def test_machine_lookup_registered_in_tool_registry():
    ...
    import unseen_university.devices.igor.tools.machine_lookup  # noqa: F401
