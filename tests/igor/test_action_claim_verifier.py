...
def test_detect_finds_i_ticketed_it():
    from unseen_university.devices.igor.cognition.action_claim_verifier import detect_action_claims
...
def test_find_evidence_returns_dict_shape():
    from unseen_university.devices.igor.cognition.action_claim_verifier import find_evidence
...
def test_find_evidence_picks_up_recent_queue_write():
    ...
    with patch(
        "unseen_university.devices.igor.cognition.action_claim_verifier._cc_queue_recently_modified",
        return_value=True,
    ):
        result = find_evidence(cortex)
...
def test_check_response_noop_on_clean_text():
    from unseen_university.devices.igor.cognition.action_claim_verifier import check_response
...
class TestSuppressFalseClaims:
    ...
    def test_strips_single_claim(self):
        from unseen_university.devices.igor.cognition.action_claim_verifier import (
...
class TestRefractoryWindow:
    ...
    def test_confab_second_fire_suppressed_when_ring_has_recent_confab(self):
        ...
        with patch(
            ...
            "unseen_university.devices.igor.cognition.action_claim_verifier._recent_tool_results",
            return_value=[],
        ):
