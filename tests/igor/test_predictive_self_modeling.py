...
class TestTokenize(unittest.TestCase):
    def _tok(self, text):
        from unseen_university.devices.igor.tools.deferred_self_task import _tokenize
...
class TestComparePredictionToResult(unittest.TestCase):
    def _cmp(self, pred, result):
        from unseen_university.devices.igor.tools.deferred_self_task import compare_prediction_to_result
...
class TestEvaluateDeferredPredictions(unittest.TestCase):
    ...
    def test_match_fires_milieu_reward(self):
        ...
        from unseen_university.devices.igor.tools.deferred_self_task import (
    ...
    def test_match_writes_prediction_match_ring(self):
        ...
        with patch("unseen_university.devices.igor.cognition.milieu") as mock_milieu_mod:
