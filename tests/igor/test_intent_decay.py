...
def test_find_aged_goals_returns_empty_for_fresh_goal():
    from unseen_university.devices.igor.tools.intent_decay import find_aged_goals
...
def test_surface_aged_intents_pushes_twm_markers():
    from unseen_university.devices.igor.tools.intent_decay import surface_aged_intents
...
def test_source_has_required_interface():
    from unseen_university.devices.igor.cognition.intent_decay_source import IntentDecaySource
