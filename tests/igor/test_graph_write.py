...
class TestStoreMemory(unittest.TestCase):
    ...
    def setUp(self):
        ...
        import unseen_university.devices.igor.tools.graph_write as gw
    ...
    def test_store_interpretive_returns_id(self):
        from unseen_university.devices.igor.tools.graph_write import store_memory
...
class TestLinkMemory(unittest.TestCase):
    ...
    def test_link_memory_creates_edge(self):
        from unseen_university.devices.igor.tools.graph_write import store_memory, link_memory
    ...
    def test_missing_parent_returns_error(self):
        from unseen_university.devices.igor.tools.graph_write import link_memory
...
class TestEmbedNode(unittest.TestCase):
    ...
    def test_embed_nonexistent_returns_error(self):
        from unseen_university.devices.igor.tools.graph_write import embed_node
    ...
    def test_embed_existing_returns_skipped_or_embedded(self):
        ...
        from unseen_university.devices.igor.tools.graph_write import store_memory, embed_node
...
class TestToolRegistration(unittest.TestCase):
    ...
    def test_all_three_tools_registered(self):
        import unseen_university.devices.igor.tools.graph_write  # noqa — triggers registration
