...
class TestParseFrontmatter(unittest.TestCase):
    def test_extracts_name(self):
        from unseen_university.devices.igor.tools.skill_importer import _parse_frontmatter
...
class TestSplitSteps(unittest.TestCase):
    def _split(self, text):
        from unseen_university.devices.igor.tools.skill_importer import _split_steps, _parse_frontmatter
    ...
    def test_no_steps_returns_empty(self):
        from unseen_university.devices.igor.tools.skill_importer import _split_steps
...
class TestExtractBashBlocks(unittest.TestCase):
    def test_finds_bash_blocks(self):
        from unseen_university.devices.igor.tools.skill_importer import _extract_bash_blocks
    ...
    def test_finds_multiple_blocks(self):
        from unseen_university.devices.igor.tools.skill_importer import (
...
class TestExtractSkillRefs(unittest.TestCase):
    def test_finds_skill_refs(self):
        from unseen_university.devices.igor.tools.skill_importer import _extract_skill_refs
...
class TestExtractHardRules(unittest.TestCase):
    ...
    def test_no_hard_rules_section(self):
        from unseen_university.devices.igor.tools.skill_importer import _extract_hard_rules
...
class TestImportSkill(unittest.TestCase):
    ...
    def test_import_filter_skill(self):
        ...
        from unseen_university.devices.igor.tools.skill_importer import import_skill
...
class TestImportAllSkills(unittest.TestCase):
    def test_imports_all_returns_summary(self):
        ...
        from unseen_university.devices.igor.tools.skill_importer import import_all_skills
