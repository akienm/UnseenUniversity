...
class TestFilterCheckInertia(unittest.TestCase):
    ...
    def _check(self, text):
        from wild_igor.igor.tools.skill_filter import filter_check_inertia
...
class TestFilterCheckTests(unittest.TestCase):
    ...
    def _check(self, text):
        from wild_igor.igor.tools.skill_filter import filter_check_tests
...
class TestFilterCheckLogging(unittest.TestCase):
    ...
    def _check(self, text):
        from wild_igor.igor.tools.skill_filter import filter_check_logging
...
class TestFilterCheckScope(unittest.TestCase):
    ...
    def _check(self, text):
        from wild_igor.igor.tools.skill_filter import filter_check_scope
...
class TestFilterCheckSize(unittest.TestCase):
    ...
    def _check(self, text):
        from wild_igor.igor.tools.skill_filter import filter_check_size
...
class TestRunFilter(unittest.TestCase):
    ...
    def _run(self, text):
        from wild_igor.igor.tools.skill_filter import run_filter
...
class TestNodeExecutorMCPCALL(unittest.TestCase):
    ...
    def test_mcpcall_run_filter_via_executor(self):
        ...
        import wild_igor.igor.tools.skill_filter  # noqa
