...
from unseen_university.devices.igor.cognition.approach_frame_audit import (  # noqa: E402
    AUDIT_WINDOW_END,
    AUDIT_WINDOW_START,
...
class TestApproachFrameAuditSource:
    ...
    def test_does_not_fire_outside_window(self):
        ...
        with patch("unseen_university.devices.igor.cognition.approach_frame_audit.datetime") as mock_dt:
            mock_now = MagicMock()
            mock_now.hour = 14
