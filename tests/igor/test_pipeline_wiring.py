...
def test_cascade_situation_importable_from_turn_pipeline():
    ...
    from unseen_university.devices.igor.cognition.turn_pipeline import CascadeSituation
...
def test_llm_peer_advisor_importable():
    from unseen_university.devices.igor.cognition.llm_peer_advisor import LLMPeerAdvisor
...
def test_turn_pipeline_constructs_with_cortex():
    from unseen_university.devices.igor.cognition.turn_pipeline import TurnPipeline
