...
from unseen_university.devices.igor.tools.table_inertia import (
    HIGH,
    LOW,
    MEDIUM,
    TableInertia,
...
class TestMachineManagerIntegration:
    ...
    def test_machines_inertia_returns_table_inertia(self):
        from unseen_university.devices.igor.tools.machine_manager import machines_inertia
    ...
    def test_machines_row_count_nonnegative(self):
        from unseen_university.devices.igor.tools.machine_manager import machines_row_count
