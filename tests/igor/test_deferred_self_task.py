...
class TestParseDeferred(unittest.TestCase):
    ...
    def _parse(self, text):
        from wild_igor.igor.tools.deferred_self_task import parse_deferred_tasks
...
class TestStripDeferred(unittest.TestCase):
    ...
    def _strip(self, text):
        from wild_igor.igor.tools.deferred_self_task import strip_deferred_tasks
...
class TestDispatchDeferred(unittest.TestCase):
    ...
    def _dispatch(self, task_type, payload="", extra_payload=""):
        from wild_igor.igor.tools.deferred_self_task import dispatch_deferred_task
...
class TestJobFunctions(unittest.TestCase):
    ...
    def test_memory_search_fn_returns_hits(self):
        from wild_igor.igor.tools.deferred_self_task import _make_job_fn
