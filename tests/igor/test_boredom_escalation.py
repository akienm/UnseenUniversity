...
from wild_igor.igor.tools.boredom_idle import _try_cascade_escalation  # noqa: E402
...
class TestCascadeEscalation:
    def test_returns_none_on_exception(self):
        ...
        with patch(
            "wild_igor.igor.memory.cortex.Cortex",
    ...
    def test_returns_none_when_no_cortex(self):
        ...
        with patch.dict("sys.modules", {"wild_igor.igor.memory.cortex": None}):
            result = _try_cascade_escalation()
        assert result is None
