...
def _make_client():
    ...
    from devices.igor.web.utility_closet_client import UtilityClosetClient
...
class TestIsAvailable:
    ...
    @patch("devices.igor.web.utility_closet_client.urllib.request.urlopen")
...
class TestClassifyOutcome:
    ...
    def test_none_is_delivered(self):
        from devices.igor.web.utility_closet_client import _classify_outcome
...
class TestPostWithTelemetry:
    ...
    def test_success_returns_delivered(self, mock_urlopen):
        from devices.igor.web.utility_closet_client import _post_with_telemetry
    ...
    def test_timeout_posts_channel_diagnostic(self, mock_urlopen):
        ...
        from devices.igor.web import utility_closet_client as ucc
...
class TestSendMessageUsesTelemetry:
    ...
    @patch("devices.igor.web.utility_closet_client._post_with_telemetry")
    @patch("devices.igor.web.utility_closet_client.urllib.request.urlopen")
