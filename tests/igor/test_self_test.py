...
class TestSelfTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from unseen_university.devices.igor.cognition.self_test import (
            _get_instance_dir,
    ...
    @patch("unseen_university.devices.igor.cognition.self_test._get_cortex")
    @patch("unseen_university.devices.igor.cognition.self_test._get_word_graph")
    @patch("unseen_university.devices.igor.cognition.self_test.get_blob_metadata")
    @patch("unseen_university.devices.igor.cognition.self_test.get_chunks")
