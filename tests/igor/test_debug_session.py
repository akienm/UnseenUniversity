...
def clean_state(tmp_path, monkeypatch):
    ...
    import wild_igor.igor.cognition.debug_session as _ds
...
def test_claim_returns_handle(clean_state):
    from wild_igor.igor.cognition.debug_session import claim
...
def test_status_active_after_claim(clean_state):
    from wild_igor.igor.cognition.debug_session import claim, status
...
def test_status_inactive_before_claim(clean_state):
    from wild_igor.igor.cognition.debug_session import status
...
def test_release_clears_flag(clean_state):
    from wild_igor.igor.cognition.debug_session import claim, release
...
def test_release_no_session(clean_state):
    from wild_igor.igor.cognition.debug_session import release
...
def test_query_returns_log_lines(clean_state):
    from wild_igor.igor.cognition.debug_session import claim, log_line, query
...
def test_full_lifecycle(clean_state):
    ...
    from wild_igor.igor.cognition.debug_session import claim, release, status
