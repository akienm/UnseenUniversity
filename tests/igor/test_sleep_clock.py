...
from unseen_university.devices.igor.cognition.sleep_clock import (  # noqa: E402
    MIN_AWAKE_HOURS,
...
class TestSleepClockSource:
    ...
    def test_fires_during_sleep_window(self):
        ...
        with patch("unseen_university.devices.igor.cognition.sleep_clock.datetime") as mock_dt:
            ...
            with patch("unseen_university.devices.igor.cognition.sleep_clock.datetime") as mock_dt2:
                mock_now = MagicMock()
                mock_now.hour = 23
