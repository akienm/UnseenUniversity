...
from unseen_university.devices.igor.memory import db_proxy as _db_proxy_module  # noqa: E402
    ...
    def test_make_home_proxy_uses_UU_HOME_DB_URL(self):
        ...
        with patch.dict(os.environ, env, clear=True):
            with patch("unseen_university.db_proxy.PGDatabaseProxy") as MockPG:
                from unseen_university.devices.igor.memory import db_proxy
...
class TestPendingReplyStore(unittest.TestCase):
    ...
    def _make_store(self, on_worry=None):
        from unseen_university.devices.igor.memory.db_proxy import make_home_proxy, make_local_proxy
        from unseen_university.devices.igor.memory.pending_replies import PendingReplyStore
