...
from wild_igor.igor.cognition.local_preparse import (
    LocalPreparser,
    preparse_local,
    default_preparser,
...
def test_never_calls_cloud_by_construction():
    ...
    import wild_igor.igor.cognition.local_preparse as mod
    import inspect
...
def test_module_level_exports():
    ...
    from wild_igor.igor.cognition import local_preparse
