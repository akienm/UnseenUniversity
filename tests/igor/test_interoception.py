...
def _make_milieu(tmp_path):
    ...
    from unseen_university.devices.igor.cognition import milieu as milieu_mod
    from unseen_university.devices.igor.cognition.milieu import Milieu
...
class TestNudgeVAD(unittest.TestCase):
    ...
    def test_nudge_adds_deltas(self):
        ...
        with (
            patch("unseen_university.devices.igor.cognition.milieu.Milieu._save"),
            patch("unseen_university.devices.igor.cognition.milieu._contribute_to_global"),
        ):
            m = self._make()
...
def _make_source():
    ...
    from unseen_university.devices.igor.cognition.push_sources import InteroceptionSource
...
class TestPushCalmNudge(unittest.TestCase):
    def test_calm_nudges_milieu_but_skips_twm(self):
        ...
        import unseen_university.devices.igor.cognition.milieu as real_milieu_mod

        with patch.dict(sys.modules, {"psutil": mock_psutil}):
            with patch("unseen_university.devices.igor.cognition.push_sources.MACHINES_JSON", ""):
                with patch.object(
