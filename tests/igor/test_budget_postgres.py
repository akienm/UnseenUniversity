...
def cleanup_tag(tag):
    ...
    yield tag
    from unseen_university.devices.igor.tools.resource_manager import _db_proxy
...
def test_record_spend_inserts_and_sums(cleanup_tag):
    from unseen_university.devices.igor.tools.resource_manager import record_spend, get_spend_total
...
def test_get_balance_trajectory_returns_dict_shape():
    ...
    from unseen_university.devices.igor.tools.resource_manager import get_balance_trajectory
...
def test_query_costs_log_handles_missing_file(tmp_path, monkeypatch):
    ...
    import unseen_university.devices.igor.paths as paths_mod
    from unseen_university.devices.igor.tools.resource_manager import query_costs_log
