...
class TestContextFormat(unittest.TestCase):
    ...
    def test_or_cheap(self):
        ...
        from wild_igor.igor.cognition.inference_openrouter import OR_CHEAP_MODEL
    ...
    def test_or_interactive(self):
        ...
        from wild_igor.igor.cognition.inference_openrouter import OR_INTERACTIVE_MODEL
