...
class TestEpisode:
    def test_to_narrative(self):
        from wild_igor.igor.memory.episode_binder import Episode
...
class TestEpisodeBinder:
    def test_basic_flush(self):
        from wild_igor.igor.memory.episode_binder import EpisodeBinder
...
class TestReplayEpisodes:
    def test_replay_filters_by_depositor(self):
        from wild_igor.igor.memory.episode_binder import replay_episodes
...
class TestCompleteEpisode:
    def test_finds_matching_episodes(self):
        from wild_igor.igor.memory.episode_binder import complete_episode
