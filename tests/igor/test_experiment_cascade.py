...
def test_level1_matches_via_widen_search():
    ...
    with patch(
        "unseen_university.devices.igor.memory.search_widen.widen_search",
...
def test_walker_handles_level_exception_gracefully():
    ...
    from unseen_university.devices.igor.cognition.experiment_cascade import BaseCascadeLevel
