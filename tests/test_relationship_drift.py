...
def test_expected_rhythm_default_for_person_is_seven_days():
    from wild_igor.igor.tools.relationship_drift import expected_rhythm_seconds
...
def test_find_drifted_skips_fresh_facia():
    ...
    from wild_igor.igor.tools.relationship_drift import find_drifted_relationships
    from wild_igor.igor.tools import persistent_relationships as _pr
...
def test_surface_pushes_twm_markers():
    from wild_igor.igor.tools.relationship_drift import surface_drifted_relationships
...
def test_source_has_required_interface():
    from wild_igor.igor.cognition.relationship_drift_source import (
