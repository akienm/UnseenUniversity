...
def run_race(verbose: bool = False) -> dict:
    ...
    """
    from lab.competition.classifiers.knn_classifier import classify as knn_classify
    from lab.competition.classifiers.llm_classifier import classify as llm_classify
