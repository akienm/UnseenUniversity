...
1. STATIC (default): AST walk over unseen_university/devices/igor/ (UnseenUniversity), devlab/claudecode/.
...
sys.path.insert(0, str(REPO_ROOT / "devlab" / "claudecode"))
...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    if args.out is None:
        ...
        args.out = (
            REPO_ROOT / "devlab" / "claudecode" / "reports" / f"logging_audit_{ts}.md"
        )
