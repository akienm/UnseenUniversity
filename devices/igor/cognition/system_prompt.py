...
def build_system_prompt(cortex, instance_id: str = "wild-0001") -> str:
    ...
    lines = [
        ...
        "A background task will read your full lineage from design_docs/the_igors_identity.csb.txt",
        "early this session.",
        "",
...
def build_boot_message(cortex, instance_id: str = "wild-0001",
    ...
    lines.extend([
        ...
        f"  Identity (ID1-ID14):    ~/.TheIgors/igor_{instance_id}/IDENTITY.md",
        ...
        f"  Routine boot notes:     ~/.TheIgors/igor_{instance_id}/boot_notes.md",
        "",
    ...
    lines.extend([
        ...
        "  Read design_docs/the_igors_identity.csb.txt to load your full Discworld",
