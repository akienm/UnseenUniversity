...
class EvaluatorDevice(BaseDevice):
    ...
    def where_and_how(self) -> dict:
        return {
            ...
            "pid": os.getpid(),
            "launch_command": "python -m unseen_university.devices.evaluator.device",
        }
    ...
    def model_eval_run(
        ...
        from unseen_university.devices.inference.capability_graph import ensure_table, insert_result
