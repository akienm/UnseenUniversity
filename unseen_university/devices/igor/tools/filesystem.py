...
def check_disk_usage() -> str:
    ...
    from unseen_university.devices.igor.paths import paths as _igor_paths
...
def _resource_load_dict() -> dict:
    ...
    """
    try:
        from unseen_university.devices.igor.network.system_proxy import system_proxy as _sp
