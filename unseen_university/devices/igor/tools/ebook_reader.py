...
Reading state (chapter + sentence offset) persisted per-book in
  ~/.unseen_university/Igor-wild-0001/reading_state.json
...
import os
import re
from unseen_university.devices.igor._sqlite_guard import real_sqlite3 as sqlite3
import sys
import tempfile
...
def _reading_extract_worker(
    ...
    try:
        ...
        try:
            from unseen_university.devices.igor.tools.registry import registry as _reg  # noqa — for logging only
            import sys as _sys
