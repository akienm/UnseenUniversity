...
Usage:
    from unseen_university.devices.igor.network.system_proxy import system_proxy
...
import logging
from .agent_base import get_logger
import os
import threading
import time
...
from .agent_base import AgentBase as IgorBase  # UC uses AgentBase
...
class SystemProxy(IgorBase):
    ...
    def network(self) -> Any:
        ...
        if not hasattr(self, "_network_cache"):
            try:
                from unseen_university.devices.igor.network.proxy import proxy as _net_proxy
    ...
    def hardware(self) -> dict[str, Any]:
        ...
        if not hasattr(self, "_hardware_cache"):
            try:
                from unseen_university.devices.igor.tools.hardware_detect import detect_hardware
