...
def _cross_type_fts(
    ...
    """
    try:
        from unseen_university.devices.librarian.node_registry import get_fts_targets
    except ImportError:
        return []
...
def recall(
    ...
    try:
        ...
        # ── 5.5. Trust scoring ───────────────────────────────────────────────
        from unseen_university.devices.librarian.trust import derive_trust_tier, passes_min_tier
