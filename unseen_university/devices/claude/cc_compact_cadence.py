...
# Resolve repo root so `python3 -m unseen_university.devices.claude.cc_compact_cadence` works and
...
from unseen_university.devices.claude.constants import (  # noqa: E402
    COMPACT_EVERY_N,
    TMUX_SESSION,
