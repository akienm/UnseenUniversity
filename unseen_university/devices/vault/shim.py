...
class VaultShim(BaseShim):
    def __init__(self, device=None) -> None:
        from unseen_university.devices.vault.device import VaultDevice
    ...
    def self_test(self) -> dict:
        ...
        # Master key
        try:
            from unseen_university.devices.vault.store import _MASTER_KEY_PATH, _load_or_create_master_key
